...
Файл `.pbix` не прикладываю (Power BI Desktop есть не у всех, а собранный
файл занимает много места и плохо живёт в git). Вместо этого — готовые
данные и подробная инструкция, как за 20–30 минут собрать дашборд самому.
Это также хороший способ показать в резюме/на собеседовании, что ты
понимаешь модель данных, а не просто нажимала кнопки.
...
## Что это показывает на собеседовании

- Умение строить модель данных (звезда, связи, DimDate)
- Владение DAX (CALCULATE, DATEADD, FILTER, DIVIDE — избегает деления на ноль)
- Понимание бизнес-метрик банка (NPL, MoM growth, retention)
